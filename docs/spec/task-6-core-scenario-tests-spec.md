...
- Task 5: 정산·접근·가드 10건 (예정)
- Task 1·2: 컨텍스트 4건, 어댑터·시드 11건

Task 4까지 실측 **79건**. Task 5·6이 끝나면 91건이다.
...
**테스트 91건 예상** — Task 1: 4, Task 2: 11, Task 3: 42, Task 4: 22, Task 5: 10, Task 6: 2. Task 1~4는 실측이고 5·6은 명세가 약속한 수다.
